...
;(function($){
    ...
    var please_vote_message = 'Оцените сайт';
    var vote_success_message = 'Спасибо. Ваш голос учтен';
    var your_score_message = 'Ваша оценка: ';
    ...
    $r.fn.extend({
    	...
    	init: function(){
    		...
    		this.vote_hover.bind('mousemove mouseover',function(e){
                ...
                self.vote_success.html(your_score_message+score);
    		    
    		 })
    		 .bind('mouseout',function(){
    			if(self.options.readOnly) return; 
    			self.reset();
                self.vote_success.html(please_vote_message);
    		 }).
    	...
    	send: function(score){
    		...
    		$.ajax({
    			...
    			success: function(data){
                  ...
                  self.vote_success.html(vote_success_message);
